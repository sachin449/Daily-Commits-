import green01 from '../assets/green01.jpg';
...
const CTA = () => {
  return (
    <div
      ...
      style={{ backgroundImage: `url(${green01})` }}
    >
      <div className="text-center mb-8 transition duration-500 ease-in-out transform hover:scale-105">
        ...
        <p className="text-lg text-pretty transition duration-500 ease-in-out transform hover:translate-y-1">At ESG Global Partners,
